...
$(document).ready(function() {
    ...
    $("#myFigure").width(window.screen.width);
    $("#myFigure").height(window.screen.height);
    var hhh =  $("#myFigure").height();
    var www = $("#myFigure").width();
    //var dim = calculateAspectRatioFit(www, hhh, $(document).width(), $(document).height());
    //$("#myFigure").width(dim.width);
    //$("#myFigure").height(dim.height);
